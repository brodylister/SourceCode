...
struct SLL
{
  ...
  {
    ///////////////////////// TO-DO (1) //////////////////////////////
    Node * newNode = new Node(data);    // step 1: always make a new node

// special cases: A: insert into middle. B: insert into empty. C: insert at tail. D: insert at head

/*
A : pos != nullptr, size != 0
B : pos == tail == head == nullptr, size == 0
C : pos == _tail, size != 0
D : pos == nullptr, size != 0
*/
    ...
    } else if (position == nullptr) { // case D

      newNode->_next = _head;
      _head = newNode;

    } else if (position == _tail) {   // case C

      newNode->_next = nullptr;
      _tail = position->_next = newNode;
    ...
    ++_size;                          // last step: increment size
    return newNode;
    /////////////////////// END-TO-DO (1) ////////////////////////////
  }
